  ...
  return (
    <div className={style.loginModalBody}>
      <div className={style.loginModal}>
        <header className={style.loginModalHeader}>
          <h2>Login</h2>
        ...
        <main className={style.loginModalMain}>
          ...
          <p className={style.separationOR}>Or</p>
          ...
          <div className={style.inputContainer}>
            ...
            <input
              type="text"
              className={style.passwordInputfield}
        ...
        <footer className={style.loginModalFooter}>
